...
HD_PWD='C:/Users/curti/OneDrive/Documents/UIUC/Duplicate/ECE-385/Vivado_Projects/Final_Project/lab_6.runs/background1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log background1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source background1_rom.tcl
