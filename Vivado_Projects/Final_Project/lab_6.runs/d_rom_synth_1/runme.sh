...
HD_PWD='C:/Users/curti/OneDrive/Documents/UIUC/Duplicate/ECE-385/Vivado_Projects/Final_Project/lab_6.runs/d_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_rom.tcl
