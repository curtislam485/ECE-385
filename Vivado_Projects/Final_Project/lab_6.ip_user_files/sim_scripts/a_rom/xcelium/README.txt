...
#
# Generated by export_simulation on Fri Dec 13 10:08:22 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './a_rom.sh' script.
...
./a_rom.sh -noclean_files

For more information on the script, please type './a_rom.sh -help'.
