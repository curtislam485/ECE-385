...
#
# Generated by export_simulation on Fri Dec 13 10:11:18 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './d_rom.sh' script.
...
./d_rom.sh -noclean_files

For more information on the script, please type './d_rom.sh -help'.
