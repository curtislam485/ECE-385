...
HD_PWD='c:/users/curti/onedrive/documents/uiuc/ece-385/vivado_projects/lab7_1/lab7_1.tmp/hdmi_text_controller_v1_0_project/hdmi_text_controller_v1_0_project.runs/hdmi_tx_0_synth_1'
cd "$HD_PWD"
